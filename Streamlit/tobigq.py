...
def searchload(lat, lon):
    #encontrar lugares segun posicion, tipo de negocio y radio de busqueda
    url = f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={lat}%2C{lon}&radius=100&type=restaurant&key=AIzaSyAHXRKJ13tnjffJ6o6AHJIhs-_EKOoTTt4"
    payload={}
    headers = {}
